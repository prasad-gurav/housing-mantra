...
const YouTubeURLForm: React.FC<YouTubeURLFormProps> = ({
	youtubeURLs,
	setYoutubeURLs,
}) => {
	...
	return (
		<div className="p-4 px-8 max-w-5xl bg-background text-primary ">
			<div className="">
				<Label className="block text-foreground text-lg font-medium ">
					YouTube URLs
				</Label>
				...
				<Button
					onClick={addURLField}
					className="mt-2 bg-primary text-white hover:bg-primary/80"
				>
					Add another URL
				</Button>
			</div>
			...
			<div className="my-4">
				...
				<Switch
					...
					onCheckedChange={setIsRERARegistered}
				/>
			</div>
